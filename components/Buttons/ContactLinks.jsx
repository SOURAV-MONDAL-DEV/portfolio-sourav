...
const ContactLinks = () => {
  return (
    <div className="flex flex-col justify-center items-center w-fit">
      ...
      <div className="flex justify-center md:justify-start flex-wrap gap-2 md:gap-6 rounded-md transform scale-90 origin-center">
       ...
       <div className="flex flex-col items-center md:flex-row md:justify-center gap-4 mt-5  ">
        <a href="https://github.com/SOURAV-MONDAL-DEV" target="_blank" className="filter brightness-150 flex items-center justify-center text-white  px-4 py-1 text-center bg-gradient-to-r from-cyan-400 to-green-400 shadow-[0px_10px_30px_1px_#4fd1c5] rounded-md ">
          <FaGithub className="mr-2 text-gray-700 text-4xl" />
          <p className="text-black font-semibold text-lg">Github</p>
        </a>
        <a href="https://drive.google.com/uc?export=download&id=1BRovtgJhJzFIhc1pcp08a9DFjn9z0PoQ"  className="filter brightness-150 flex items-center justify-center text-white  px-4 py-1 text-center bg-gradient-to-r from-cyan-400 to-green-400 shadow-[0px_10px_30px_1px_#4fd1c5] rounded-md ">
